...
1. Mobile 流程层：
   `app/mobile/ui/js/flows/*`
2. Relay 配对与鉴权：
   `services/relay/src/pairing/*`
   `services/relay/src/auth/*`
   `services/relay/src/ws/*`
3. Sidecar 会话与工具发现：
   `services/sidecar/src/session/*`
   `services/sidecar/src/tooling/core/*`
   `services/sidecar/src/tooling/adapters/*`

## 4. 当前状态引用

1. 验收执行：`docs/已完成功能验收-v1.md`
2. 里程碑状态：`docs/里程碑与待办-v1.md`
3. 协议与安全：`docs/配对与宿主机接入/02-协议与安全方案-v1.md`
