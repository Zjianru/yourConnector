...
export function createRuntime() {
  return {
    ...
    toolDetailsById: {},
    toolDetailStaleById: {},
    toolDetailUpdatedAtById: {},
    toolDetailsLastSnapshotId: 0,
    toolDetailsLastRefreshId: "",
    toolDetailsLastTrigger: "",
    toolDetailsPendingAllRefreshId: "",
    toolDetailsPendingRefreshByToolId: {},
    logicalToolIdToRuntimeToolId: {},
    runtimeToolIdToLogicalToolId: {},
    toolCapabilityChangesByToolId: {},
    opencodeInvalidByLogicalToolId: {},
    openclawWorkspaceByToolId: {},
    tools: [],
    candidateTools: [],
    candidateSnapshotVersion: 0,
    candidateRefreshPending: false,
    candidateExpectedVersion: 0,
