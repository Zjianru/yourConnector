...
5. `app/mobile/ui/js/services/*`：服务层
6. `app/mobile/ui/js/flows/*`：流程层
7. `app/mobile/ui/js/views/*`：渲染层
8. `app/mobile/ui/js/modals/*`：弹窗层

工具详情链路关键文件：

1. `app/mobile/ui/js/modals/tool-detail.js`：按 `schema` 渲染 openclaw/opencode 详情
